          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center">
                ...
                <h1 className="text-xl font-semibold text-white">Vibe Coding</h1>
              </div>
              <div className="flex items-center space-x-4">
                ...
                {/* Electro gradient sign out button */}
                <div className="group relative inline-block">
                  <div className="absolute inset-0 rounded-lg overflow-hidden">
                    <div className="absolute inset-0 bg-linear-to-r from-yellow-400 via-cyan-400 to-purple-400 opacity-20 animate-pulse" />
                    <div className="absolute inset-0 bg-linear-to-br from-blue-500 via-purple-500 to-pink-500 opacity-30 animate-pulse animation-delay-500" />
                  ...
                  <button 
                    ...
                    className="relative px-4 py-2 bg-black text-white text-sm font-medium rounded-lg border border-gray-800 hover:border-yellow-400/50 hover:bg-gray-900 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-yellow-400/25"
                  >
                    Sign Out
                  </button>
                </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-gray-900/90 backdrop-blur-sm border border-gray-800 rounded-lg p-6">
                ...
                <div className="text-center py-8">
                  ...
                  {/* Electro gradient create project button */}
                  <Link href="/workspace/new">
                    <div className="group relative inline-block">
                      <div className="absolute inset-0 rounded-lg overflow-hidden">
                        <div className="absolute inset-0 bg-linear-to-r from-yellow-400 via-cyan-400 to-purple-400 opacity-20 animate-pulse" />
                      ...
                      <button className="relative px-6 py-3 bg-black text-white font-bold rounded-lg border border-gray-800 hover:border-yellow-400/50 hover:bg-gray-900 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-yellow-400/25 flex items-center">
